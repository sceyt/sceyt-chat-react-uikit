...
export const MARK_MESSAGE_AS_OPENED = 'MARK_MESSAGE_AS_OPENED'
export const UPDATE_MESSAGE_AS_OPENED = 'UPDATE_MESSAGE_AS_OPENED'
...
export const RESEND_PENDING_CHANNEL_READS = 'RESEND_PENDING_CHANNEL_READS'
...
export const JOIN_TO_CHANNEL_WITH_INVITE_KEY = 'JOIN_TO_CHANNEL_WITH_INVITE_KEY'
export const DRAFT_IS_REMOVED = 'DRAFT_IS_REMOVED'
export const SET_MESSAGE_RETENTION_PERIOD = 'SET_MESSAGE_RETENTION_PERIOD'
export const GET_CHANNELS_WITH_USER = 'GET_CHANNELS_WITH_USER'
export const LOAD_MORE_MUTUAL_CHANNELS = 'LOAD_MORE_MUTUAL_CHANNELS'

export const CHANNEL_EVENT_TYPES = {
  POLL_ADDED: 'POLL_ADDED',
  POLL_DELETED: 'POLL_DELETED',
  POLL_RETRACTED: 'POLL_RETRACTED',
