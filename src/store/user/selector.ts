export const connectionStatusSelector = (store: any) => store.UserReducer.connectionStatus
export const contactListSelector = (store: any) => store.UserReducer.contactList
export const contactsMapSelector = (store: any) => store.UserReducer.contactsMap
export const rolesMapSelector = (store: any) => store.UserReducer.rolesMap
