...
function App() {
  ...
  console.log('render app component', client)

  return (
    <div className='App'>
      <header className='App-header'>
        <p>Sceyt livechat demo</p>
      </header>
      ...
      <div className='livechat_wrapper'>
        ...
        <div
          className={`live_chat_container ${liveChatOpen && 'live_chat_container_opened'} ${
            isMobile ? 'mobile_livechat' : ''
          }`}
        >
          ...
          <div className='sceyt_livechat'>
            {client ? (
              <SceytChat showNotifications={false} client={client} autoSelectFirstChannel={true}>
                <Chat onSelectedChannelUpdated={handleUpdateUnreadCount} hideChannelList={true}>
                  ...
                  <SendMessage voiceMessage={false} allowMentionUser={false} allowTextEdit={false} />
                </Chat>
              </SceytChat>
            ) : (
